...
public class CurrencyEntity {
    ...
    public CurrencyEntity(String code, double rate) {
        this.code = code;
        this.rate = rate;
        switch (this.code) {
            case "EUR":
                this.type = Currency.EUR;
                break;
            case "USD":
                this.type = Currency.USD;
                break;
            case "JPY":
                this.type = Currency.JPY;
                break;
            case "CHF":
                this.type = Currency.CHF;
                break;
            case "CNY":
                this.type = Currency.CNY;
                break;
            default:
                this.type = null;
                break;
