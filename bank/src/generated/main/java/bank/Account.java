...
public interface Account extends com.zeroc.Ice.Object
{
    ...
    UserData getUserData(com.zeroc.Ice.Current current);
    ...
    **/
     ...
     * @return -
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_getUserData(Account obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
    {
        com.zeroc.Ice.Object._iceCheckMode(null, current.mode);
        inS.readEmptyParams();
        UserData ret = obj.getUserData(current);
        com.zeroc.Ice.OutputStream ostr = inS.startWriteParams();
        UserData.ice_write(ostr, ret);
        inS.endWriteParams(ostr);
        return inS.setResult(ostr);
    }
    ...
    **/
        ...
        throws com.zeroc.Ice.UserException
    {
        ...
        switch(pos)
        {
            ...
            case 2:
            {
                return _iceD_getUserData(this, in, current);
            }
            case 3:
            {
